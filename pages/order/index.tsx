            ...
            <Flex className={styles.container}>
                ...
                <Details {...details} />
                {
                    banners?.length ? <Flex align="center" pb={4} gap={4} px={4} className={styles.bannerContainer}>
                        {banners.map((el: any, i: number) => <Box key={i} className={styles.banner}><a href={el.href} target="_blank" rel="noreferrer"><img width="100%" height="100%" src={el.src} alt={el.alt} /></a></Box>)}
                    </Flex> : <></>
                }
